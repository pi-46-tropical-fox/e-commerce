    ...
    <div class="container2">
      <div class="overlay" id="overlay">
        <div class="sign-in" id="sign-in" style="padding-left: 10px">
          <h1>Welcome Back!</h1>
          <p>Doesn't have account yet? please sign up with your personal info</p>
          <button @click.prevent="$router.push('/signup')" class="switch-button" id="slide-right-button">Sign Up</button>
        </div>
      </div>
      <div class="form">
        <div class="sign-up" id="sign-up-info">
          <h1 style="font-size: 55px; margin-bottom: 20px">Start Your Journey!</h1>
          <form @submit.prevent="login" id="sign-up-form">
            <input v-model="email" type="email" placeholder="Email" />
            <input v-model="password" type="password" placeholder="Password" />
            <button type="submit" class="control-button up" style="margin-top: 40px">Sign In</button>
          </form>
        </div>
      </div>
    </div>
