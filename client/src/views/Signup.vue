    ...
    <div class="container2">
      <div class="overlay" id="overlay">
        <div class="sign-in" id="sign-in" style="padding-left: 10px">
          ...
          <button @click.prevent="$router.push('/signin')" class="switch-button" id="slide-right-button">Sign In</button>
        </div>
      </div>
      <div class="form">
        <div class="sign-up" id="sign-up-info">
          <h1 style="font-size: 55px; margin-bottom: 20px">Create Account</h1>
          <form @submit.prevent="register" id="sign-up-form">
            <input v-model="email" type="email" placeholder="Email" />
            <input v-model="password" type="password" placeholder="Password" />
            <button type="submit" class="control-button up" style="margin-top: 40px">Sign Up</button>
          </form>
        </div>
      </div>
    </div>
